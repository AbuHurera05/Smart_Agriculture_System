                  ...
                  {removed ? (
                    ...
                    <>
                      <p className="text-sm font-semibold text-primary mt-1">
                        ₹{current.price.toLocaleString()} <span className="text-xs font-normal text-gray-500">/ {current.unit}</span>
                      </p>
                      {priceChanged && (
                        <p className="text-xs text-warning">Price changed from ₹{w.price?.toLocaleString()}</p>
                      )}
